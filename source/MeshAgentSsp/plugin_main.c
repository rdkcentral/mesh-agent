    ...
    )
{
    ...
    pPlugInfo->RegisterFunction(pPlugInfo->hContext, "SecureBackhaul_GetParamBoolValue",  SecureBackhaul_GetParamBoolValue);
    pPlugInfo->RegisterFunction(pPlugInfo->hContext, "SecureBackhaul_SetParamBoolValue",  SecureBackhaul_SetParamBoolValue);
    pPlugInfo->RegisterFunction(pPlugInfo->hContext, "HDRecommendation_GetParamBoolValue",  HDRecommendation_GetParamBoolValue);
    pPlugInfo->RegisterFunction(pPlugInfo->hContext, "HDRecommendation_SetParamBoolValue",  HDRecommendation_SetParamBoolValue);
